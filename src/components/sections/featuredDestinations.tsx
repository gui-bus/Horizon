  ...
  const items = [
    {
      ...
      subtitle: t("items.kyoto.subtitle"),
      image: "/content/destinations/kyoto.webp",
      tag: t("items.kyoto.tag"),
    },
    {
      id: "patagonia",
      title: t("items.patagonia.title"),
      subtitle: t("items.patagonia.subtitle"),
      image: "/content/destinations/patagonia.webp",
      tag: t("items.patagonia.tag"),
    },
    {
      id: "santorini",
      title: t("items.santorini.title"),
      subtitle: t("items.santorini.subtitle"),
      image: "/content/destinations/santorini.webp",
      tag: t("items.santorini.tag"),
    },
    {
      id: "swiss",
      title: t("items.swiss.title"),
      subtitle: t("items.swiss.subtitle"),
      image: "/content/destinations/swissAlps.webp",
      tag: t("items.swiss.tag"),
    },
    {
      id: "marrakech",
      title: t("items.marrakech.title"),
      subtitle: t("items.marrakech.subtitle"),
      image: "/content/destinations/marrakechDesert.webp",
      tag: t("items.marrakech.tag"),
    },
  ];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          <div className="max-w-2xl">
            <span className="text-[10px] font-bold uppercase tracking-[0.5em] text-accent mb-6 block">
              {t("badge")}
            </span>
        ...
        <div className="flex flex-col lg:flex-row gap-20 items-start">
          ...
          <div className="w-full lg:w-1/3 flex flex-col order-2 lg:order-1">
            {items.map((item, i) => (
              ...
              >
                <span
                  className={`font-serif italic text-2xl transition-colors duration-700 ${activeId === item.id ? "text-accent" : "text-foreground/20"}`}
                >
                  0{i + 1}
                </span>
                <span
                  className={`text-3xl md:text-5xl font-serif font-light tracking-tight uppercase transition-all duration-700 ${activeId === item.id ? "text-foreground tracking-[0.1em]" : "text-foreground/20"}`}
                >
                  {item.title}
                </span>
                {activeId === item.id && (
                  <motion.div
                    layoutId="active-dot"
                    className="ml-auto w-2 h-2 rounded-full bg-accent shadow-[0_0_15px_rgba(var(--accent-rgb),0.5)]"
                  />
                )}
              </button>
            ))}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="absolute inset-0 p-12 lg:p-20 flex flex-col justify-end">
                    ...
                    >
                      <span className="text-accent text-[10px] font-bold uppercase tracking-[0.6em] mb-8 block">
                        {activeItem.tag}
                      </span>
        ...
        <div className="mt-32 pt-16 border-t border-border/50 flex flex-col md:flex-row justify-between items-center gap-12">
          ...
          <button
            type="button"
            className="group flex items-center gap-8 text-[10px] font-bold uppercase tracking-[0.4em] text-accent hover:text-foreground transition-all duration-500"
          >
