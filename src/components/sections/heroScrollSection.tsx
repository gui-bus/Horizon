...
export default function HeroScrollSection() {
  ...
  return (
    <section
      className="relative min-h-screen bg-background pt-32 lg:pt-48 overflow-hidden"
      id="hero"
    >
      ...
      <div className="absolute top-1/2 left-12 -translate-y-1/2 hidden xl:block pointer-events-none">
        <p className="text-[9px] font-bold uppercase tracking-[0.5em] text-foreground/20 [writing-mode:vertical-lr] rotate-180">
          {t("boutique_tag")}
        </p>
      </div>
