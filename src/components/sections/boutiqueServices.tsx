      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-7xl md:text-9xl lg:text-[11rem] font-serif font-light text-foreground leading-[0.8] tracking-tighter uppercase">
            The <br />
            <span className="italic text-accent/40 lowercase ml-12">Expertise</span>
          </h2>
        </motion.div>
          ...
          {services.map((service, i) => (
            ...
            >
              ...
              <div className="w-full lg:w-7/12 relative aspect-[16/10] overflow-hidden rounded-[2rem] lg:rounded-[4rem] shadow-[0_40px_100px_rgba(0,0,0,0.08)] border border-border/40 group">
                ...
                {/* FLOATING INDEX */}
                <div className={`absolute top-12 ${service.align === 'right' ? 'right-12' : 'left-12'} hidden md:block`}>
                   <span className="font-serif italic text-6xl text-white/80">0{i + 1}</span>
                </div>
              </div>
              ...
              <div className="w-full lg:w-5/12 flex flex-col justify-center">
                <div className="max-w-md">
                  <span className="text-accent text-[10px] font-bold uppercase tracking-[0.5em] mb-8 block">{service.tag}</span>
                  ...
                  <button className="group flex items-center gap-8 text-[10px] font-bold uppercase tracking-[0.4em] text-foreground hover:text-accent transition-all duration-500">
                    <span className="group-hover:tracking-[0.6em] transition-all duration-500">View Collection</span>
